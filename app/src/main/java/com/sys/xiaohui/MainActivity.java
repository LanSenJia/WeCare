...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //默认首页，点击主页按钮 跳转该网页
    private String homeUrl = "https://wecareservices.xyz/";
    ...
    protected void startReadUrl(String url) {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                // TODO Auto-generated method stub
                setTitle("wecare " + newProgress + "%");
                if (newProgress == 100) {
                    //关闭进度条
                    setTitle("wecare has been loaded");
                    closeProgressBar();
                } else {
                    //开启进度条
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_login:
                //拼接网址
                url = "https://" + et_url.getText().toString();
                //除去空格
                url = url.replace(" ", "");
                startReadUrl(url);
                break;
            ...
            case R.id.btn_menu:
                //主页
//                et_url.setText(homeUrl);
                startReadUrl(homeUrl);
                break;
        }
    }
}